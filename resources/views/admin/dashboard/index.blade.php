                    ...
                    <a href="{{ route('users.index') }}">
                        <div class="widget">
                            <div class="widget-body">
                                ...
                                <small class="text-small mt-10 d-block">Total Users</small>
                            </div>
                    ...
                    <a href="{{ route('products.index') }}">
                        <div class="widget">
                            <div class="widget-body">
                                ...
                                <small class="text-small mt-10 d-block">All Products</small>
                            </div>
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-success" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"></div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card" style="min-height: 422px;">
                        <div class="card-header"><h3>Login Details</h3></div>
                        <div class="card-body">
                            <h6>Last Login:</h6>
                            <h6><a href="{{ route('users.edit',!empty($last_login->user->id) ? $last_login->user->id : "#") }}" target="_blank" class="text-primary">{{ !empty($last_login->user->name) ? $last_login->user->name : "" }}</a></h6>
                            <p class="text-black-50">
                                IP: {{ $last_login->ip_address ?? null }} <br>
                                Device: {{ $last_login->os ?? null }} , {{ $last_login->browser ?? null }} <br>
                                Location: {{ $last_login->country ?? null }} <br>
                                Time : {{ $last_login?->created_at?->diffForHumans() ?? null}}
                            </p>
