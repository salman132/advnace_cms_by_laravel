    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-md-12 col-sm-12">
                <form action="{{ route('posts.update',$blog->id) }}" method="post" enctype="multipart/form-data" class="col-md-12">
                    @method('PUT')
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-md-8 col-12 col-sm-12">
                            <div class="text-area">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" placeholder="Your Blog Title" class="form-control" value="{{$blog->title}}">
                                </div>
                                <div class="form-group">
                                    <label>Blog Content <span class="text-danger">*</span></label>
                                    <textarea name="blog_content"  cols="30" rows="10" class="form-control summernote">{!! $blog->content !!}</textarea>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-5 col-12">
                            <img id="blah" src="{{ asset($blog->image) }}" alt="" class="img-fluid">
                            <div class="form-group">
                                <br>
                    ...
                    <input type="submit" value="Update" class="btn-lg btn-primary form-control active">
                </form>
