                ...
                <div class="modal-body">
                    <form action="{{ route('send.mail') }}" method="post">
                        ...
                        <div class="form-group">
                            <label for="recipient-user" class="col-form-label">Recipient:</label>
                            <input type="text" name="email" class="form-control" id="recipient-user">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="message-text-mail" class="col-form-label">Message:</label>
                            <textarea class="form-control" name="mail_body" id="message-text-mail"></textarea>
                        </div>
